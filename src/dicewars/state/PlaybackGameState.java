...
public class PlaybackGameState extends GameState implements MouseListener {
    ...
    public PlaybackGameState(Renderer r) {
        this.renderer = r;
    }
    ...
    public void update() {
        ...
        if (currentPlayer instanceof AIPlayer && currentTime - lastAITick > 300000000) {
